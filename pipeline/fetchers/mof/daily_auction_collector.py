...
from pipeline.fetchers.mof.calendar_collector import AuctionCalendarCollector
from pipeline.fetchers.mof.liquidity_supply_collector import LiquiditySupplyCollector
from pipeline.fetchers.mof.tdb_collector import TDBCollector
    ...
    def _save_auction_record(self, record: Dict, auction_type: str) -> bool:
        ...
        try:
            ...
            result = self.db.batch_insert_data(
                ...
                conflict_target='bond_code,auction_date'
            )
            return result > 0
        except Exception as e:
