...
# Macro Economic Data Collection (Stock, FX, US Yields, CPI) - 07:10
create_job "daily-macro-collection" "10 7 * * *" "/api/scheduler/macro-daily-collection" "Daily Macro Economic Data (Stock/FX/Yields) collection"
